...
if datatype[a,b]==4 && string_count("#",string(value[a,b]))>0
{
    ...
    {
    if (string_char_at(valcopy,readpos)=="#" or readpos==string_length(valcopy))
    {
    ...
    {
    if datatype[a,b-1]==0 or datatype[a,b-1]==3 or datatype[a,b-1]==4 {linecount[a,b]=linecount[a,b-1]+1;}
    if datatype[a,b-1]==1 or datatype[a,b-1]==2 {linecount[a,b]=linecount[a,b-1]+2;}
    }
    lastpos=readpos+1;
    b++;
...
if b==0 {linecount[a,b]=1; return b;}
else
{
if datatype[a,b-1]==0 or datatype[a,b-1]==3 or datatype[a,b-1]==4 {linecount[a,b]=linecount[a,b-1]+1; return b;}
if datatype[a,b-1]==1 or datatype[a,b-1]==2 {linecount[a,b]=linecount[a,b-1]+2; return b;}
}
}
}
