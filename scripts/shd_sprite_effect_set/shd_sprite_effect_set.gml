...
if object_index==obj_player && (arg==2 or arg==3) { //ultimate activation
...
if object_index==obj_player u_brightnessIntensity=-1+(obj_player.flash_clock/20);
else u_brightnessIntensity=(obj_player.flash_clock/40)-1;
if fps>50 && gpspeed!=0 u_flickerInterval=3;
}
