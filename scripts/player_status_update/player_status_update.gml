...
{ds_grid_set_grid_region(player_status_effects,player_status_effects,0,i+1,2,ds_grid_height(player_status_effects)-1,0,i); i--;}
...
case 8: player_status_add(6,obj_player.ucooldown,0); global.gpspeed_ultimate=1; break;
case 9: player_status_add(6,1200,0); player_status_add(4,600,1); obj_player.evilflame_twilight_fury=0; obj_player.sprite_index=spr_evilflame; break;
}
}
}
