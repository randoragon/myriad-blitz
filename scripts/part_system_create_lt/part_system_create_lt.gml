/// @description part_system_create_lt(draw_oldtonew,base_slots,'limit)
/// @param draw_oldtonew
/// @param base_slots
/// @param 'limit
function part_system_create_lt() {
