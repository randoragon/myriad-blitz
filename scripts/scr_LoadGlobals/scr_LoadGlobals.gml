...
function scr_LoadGlobals() {
	...
	if (version_ge(ver, "1.2.1")) {
		...
		global.sfx_shoot       = string_readln_real(args);
		global.sfx_bullet_hit  = string_readln_real(args);
		global.sfx_frag_hit    = string_readln_real(args);
		global.sfx_charge_shot = string_readln_real(args);
