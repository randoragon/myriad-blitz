...
for (var i = 1; i <= string_length(input); i++) {
    if (string_char_at(input, i) != " ") {
		...
		switch(argument[3]) {
			case 1: part = PART_TYPE_INDICATORS_1; break;
			case 2: part = PART_TYPE_INDICATORS_2; break;
			case 3: part = PART_TYPE_INDICATORS_3; break;
		}
        ...
        part_type_spawn_pro(PART_SYSTEM_DAMAGE_INDICATORS, part, 0, xpos, ypos, xpos, ypos, "line", "linear", 1);
    }
}