...
arg=argument[0];
u_waveAmplitude_x=0; u_waveAmplitude_y=0;
u_waveClock_x=0; u_waveClock_y=0;
u_wavingSpeed_x=0; u_wavingSpeed_y=0;
u_waveLength_x=0; u_waveLength_y=0;
u_blendIntensity=0;
...
if arg>=8 && arg<=15 { //current crush
u_gptime=0;
u_waveAmplitude_x=7; u_waveAmplitude_y=7;
u_waveClock_x=gptime; u_waveClock_y=gptime+30;
u_wavingSpeed_x=6; u_wavingSpeed_y=6;
u_waveLength_x=300; u_waveLength_y=400;
u_colorBlend=rgb(0,115,255);
if obj_player.flash_clock<40 {
if obj_player.flash_clock>0 u_blendIntensity=(40-obj_player.flash_clock)/40;
else u_blendIntensity=1;
}
}
