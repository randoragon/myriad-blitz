...
/// @param loops
/// @param pitch[%]
if argument_count>=4 var pitchpercentage=argument[3]; else var pitchpercentage=100;

for(var musiccount=0; musiccount<array_length_1d(global.music); musiccount++)
{
if !audio_is_playing(global.music[musiccount]) or (audio_sound_get_gain(global.music[musiccount])==0 && global.muspercentage>0)
{
