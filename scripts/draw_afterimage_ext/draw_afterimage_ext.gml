/// @description draw_afterimage_ext(count, alpha, fadeout, frameskip, rate, sprite, subimg, x, y, image_xscale, image_yscale, image_angle);
/// @param count
/// @param alpha
/// @param fadeout
/// @param frameskip
...
function draw_afterimage_ext() {
	...
	if (grid[# 0, 0] <= 0) {
	    ...
	    grid[# new_column, 0] = argument[5];
	    grid[# new_column, 1] = argument[6];
	    grid[# new_column, 2] = argument[7];
	    grid[# new_column, 3] = argument[8];
	    grid[# new_column, 4] = argument[9];
	    grid[# new_column, 5] = argument[10];
	    grid[# new_column, 6] = argument[11];
