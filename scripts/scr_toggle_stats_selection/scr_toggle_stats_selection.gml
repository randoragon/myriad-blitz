...
/// @param bool
if !instance_exists(obj_statboard) or !instance_exists(obj_statboard.button[1]) exit;

with(obj_statboard.button[1])
{
customize=argument[0]; image_index=2*customize;
if customize==1
{
with(obj_statboard)
{
