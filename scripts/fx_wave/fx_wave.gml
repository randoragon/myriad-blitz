/// @description fx_wave(1/4xwave,2/4xwave,3/4xwave,4/4xwave,xradius,xcycle,xoffset,xduration,1/4ywave,2/4ywave,3/4ywave,4/4ywave,yradius,ycycle,yoffset,yduration)
/// @param 1/4xwave
/// @param 2/4xwave
/// @param 3/4xwave
/// @param 4/4xwave
...
/// @param yduration
    ...
    a) 4 arguments (radius, cycle, offset, duration)
    b) 8 arguments (first 8 arguments)
    c) 16 arguments 
