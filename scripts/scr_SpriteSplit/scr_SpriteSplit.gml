...
/// @param alpha
/// @param direction
function scr_SpriteSplit() {

	/* This function was created for recreating split enemies in save slot loading.
	 * It creates a 1D array with 2 values: top and bottom half of the cut sprite.
	 */
