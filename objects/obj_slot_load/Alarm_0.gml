...
if spawncount>1 {
spawncount--;
while((page*6)+spawncount+1>array_length_1d(slot)) {spawncount--; if spawncount<0 exit;}

var xshift=300;
var yshift=115;
switch(spawncount)
{
case 1: xx=x-(0.5*xshift); yy=y-213+(yshift); break;
case 2: xx=x+(0.5*xshift); yy=y-213+(yshift); break;
