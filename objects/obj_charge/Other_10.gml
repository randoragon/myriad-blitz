...
case 0:
    ...
    if spawn.evilflame_sprite_swap spawn.sprite_index=spr_evilflame_ultimate;
    else spawn.sprite_index=spr_evilflame;
    direction=spawn.image_angle; speed1=5;
    image_speed=0.6*gpspeed;
    charge=100;
    break;
    case 1: //evilflame's dual clone charge
    sprite_index=spr_evilflame_charge;
    if spawn.evilflame_sprite_swap obj_evilflame_ultimate.sprite_index=spr_evilflame;
    else obj_evilflame_ultimate.sprite_index=spr_evilflame_ultimate;
    direction=-spawn.image_angle; speed1=5;
    image_speed=0.6*gpspeed;
    charge=100;
    break;
    ...
    image_scale(0.3,0.3);
    direction=point_direction(x,y,CANVAS_XMID,CANVAS_YMID); speed1=10;
