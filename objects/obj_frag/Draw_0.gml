...
if (f == PLAYER_BOBILEUSZ && (e == 0 || e == 2)) {
	...
	tex = texture_get_uvs(surface_get_texture(surface_page_index("projectile", suf1)));
	w   = surface_get_width(surface_page_index("projectile", suf1));
	h   = surface_get_height(surface_page_index("projectile", suf1));
