/// @description lock busywise
if obj_slot_load.start_busy!=busy exit;

///appear & disappear
if phase==0 {image_scale(home(image_xscale,1,0.1,0),image_xscale); if image_xscale==1 phase=1;}
if phase==2 {if image_xscale>0 image_scale(home(image_xscale,0,0.1,0),image_xscale); else instance_destroy();}
