...
//Initial load of custom shown stats data, MUST be used directly after scr_Stats_Update(1);
...
if elementid[l,m]==i {var prev=listed[i]; listed[i]=ini_read_real("shown_stats",string(i),-1); if listed[i]==-1 listed[i]=prev;}
button[0].show=ini_read_real("shown_stats","show",0); button[0].image_index=button[0].show*2;
ini_close();
}
