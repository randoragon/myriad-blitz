...
draw_text_outline((image_width + hpadding + uname_width) / 2, 0, "ULTIMATE MOVE!!!", size * multiplier / 2, size * multiplier / 2, 0, c_white, 2, c_black);
draw_set_align(fa_left, fa_top);
draw_text_outline(image_width + hpadding, headline_height + vpadding, text, size * multiplier, size * multiplier, 0, c_white, 2, c_black);
