...
if size>=5 {play_sfx(sfx_ultimate_activation,sound_priority.ultimate_activation,0); stage=1;}
}
else if stage==1 {
...
if size>=11 {instance_destroy(); surface_free(suf_mysurface);}
...
//update measurement variables
    ...
    hpadding=4*size*multiplier; vpadding=size*multiplier;
