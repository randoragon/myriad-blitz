...
case 10: sprite_index=spr_button_pause_bar; image_index=0; image_speed=0; prev_image_speed=0; image_blend=rgb(255,162,30); depth=gui_depth.pause_menu; break;
case 11: sprite_index=spr_button_pause_bar; image_index=0; image_speed=0; prev_image_speed=0; image_blend=rgb(4,157,255); depth=gui_depth.pause_menu; break;
case 12: sprite_index=spr_button_pause_bar; image_index=0; image_speed=0; prev_image_speed=0; image_blend=rgb(255,69,69); depth=gui_depth.pause_menu; break;
...
case 15: sprite_index=spr_button_pause_bar; image_index=0; image_speed=0; image_blend=rgb(255,182,50); depth=gui_depth.pause_menu; break;
case 16: sprite_index=spr_waterflame_button; image_index=0; image_speed=0; break;
case 17: sprite_index=spr_slot_load_arrows; image_index=0; image_speed=0; depth=gui_depth.slot_load_button; break;
case 18: sprite_index=spr_slot_load_arrows; image_index=0; image_speed=0; image_xscale=-1; depth=gui_depth.slot_load_button; break;
case 19: sprite_index=spr_slot_load_rename; image_index=2; image_speed=0; depth=gui_depth.slot_load_button; break;
case 20: sprite_index=spr_slot_load_delete; image_index=2; image_speed=0; depth=gui_depth.slot_load_button; break;
...
case 23: sprite_index=spr_stats_checkbox; image_speed=0; image_index=0; depth=gui_depth.settings_checkbox; break;
case 24: sprite_index=spr_size_button; image_index=0+(3*(global.save_chunk_size==200)); image_speed=0; depth=gui_depth.settings_checkbox; break;
case 25: sprite_index=spr_size_button; image_index=1+(3*(global.save_chunk_size==500)); image_speed=0; depth=gui_depth.settings_checkbox; break;
case 26: sprite_index=spr_size_button; image_index=2+(3*(global.save_chunk_size==1500)); image_speed=0; depth=gui_depth.settings_checkbox; break;
