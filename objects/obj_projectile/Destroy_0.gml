/// @description disperse particles
if lifespan<=0
switch(f) {
case 0:
...
break;
case 2:
if e==0 disperse_particles(global.part_system[5],x,x,y,y,irandom_range(3,5),c_yellow);
else if e==1 disperse_particles(global.part_system[5],x,x,y,y,irandom_range(3,5),c_red);
break;
default:
